...
import gzip, sqlite3, argparse, pickle
...
parser.add_argument('-o','--outDB', metavar="OUTDB", type=str, default='../data/gene.chrom.pos.lookup.sqlite3.db', help='Output sqlite3 database file name')
parser.add_argument('-p','--outPickle', metavar="OUTPICKLE", type=str, default='../data/gene.symbol.pickle', help='Output Python pickle object for gene name to symbol lookup')
